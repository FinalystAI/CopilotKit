...
const getVersionMismatchErrorMessage = ({
  ...
  `Version mismatch detected: @finalyst/runtime@${runtimeVersion ?? ""} is not compatible with @finalyst/react-core@${reactCoreVersion} and @finalyst/runtime-client-gql@${runtimeClientGqlVersion}. Please ensure all installed copilotkit packages are on the same version.`;
/**
