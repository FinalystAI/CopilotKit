...
<Steps>
  ...
  <Step>
    ...
    import { useCopilotChatHeadless_c } from "@finalyst/react-core"; // [!code highlight]
...
```tsx title="src/app/components/chat.tsx"
import { useCopilotChatHeadless_c, useCopilotChatSuggestions } from "@finalyst/react-core"; // [!code highlight]
...
```tsx title="src/app/components/chat.tsx"
import { useCopilotAction, useCopilotChatHeadless_c } from "@finalyst/react-core";
