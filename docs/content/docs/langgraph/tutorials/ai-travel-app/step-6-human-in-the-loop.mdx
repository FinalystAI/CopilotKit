...
import { useCoAgent, useCoAgentStateRender } from "@finalyst/react-core"; // [!code --]
import { useCoAgent, useCoAgentStateRender, useCopilotAction } from "@finalyst/react-core"; // [!code ++]
// ...
